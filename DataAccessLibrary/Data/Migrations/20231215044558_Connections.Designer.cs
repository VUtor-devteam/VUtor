...
namespace DataAccessLibrary.Data.Migrations
{
    ...
    [Migration("20231215044558_Connections")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Connection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.ConnectionRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.Connection", b =>
                {
                    b.HasOne("DataAccessLibrary.Models.ProfileEntity", "Friend")
                        .WithMany()
                        .HasForeignKey("FriendId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataAccessLibrary.Models.ProfileEntity", "User")
            ...
            modelBuilder.Entity("DataAccessLibrary.Models.ConnectionRequest", b =>
                {
                    b.HasOne("DataAccessLibrary.Models.ProfileEntity", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataAccessLibrary.Models.ProfileEntity", "Sender")
